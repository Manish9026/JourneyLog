...
<LuMenu />
   ...
   <div className={`${isNavActive? "max-h-[400px] opacity-100" : "max-h-[0] opacity-0"} transition-all duration-500 overflow-hidden  flex flex-col list-none secondary-font capitalize`}>
   {
